...
class MorphologyExClose(Class, BaseWidget):
	...
	def __init__(self, **kwargs):
		...
		self._formset = [
			('_use_morphologyexclose','_field_morphologyexclose_kernel_size')
		]
	...
	def __update_param_morphologyex_kernel_size(self):
		self._param_morphologyexclose_kernel_size = kernel_size = self._field_morphologyexclose_kernel_size.value 
